...
//    Other public methods
      void SetEarthExplorerDialogX         (int x){ m_hr_dialog_x = x;};
      void SetEarthExplorerDialogY         (int x){ m_hr_dialog_y = x;};
      void SetEarthExplorerDialogWidth     (int x){ m_hr_dialog_width = x;};
      void SetEarthExplorerDialogHeight    (int x){ m_hr_dialog_height = x;};  
	  void SetEarthExplorerDialogSizeX     (int x){ m_hr_dialog_sx = x; }
	  void SetEarthExplorerDialogSizeY     (int x){ m_hr_dialog_sy = x; }
	  void OnEarthExplorerDialogClose();
...
private:
	...
	double          m_GUIScaleFactor;
	  ...
	  bool				m_bEarthExplorerShowIcon;
	  bool				m_bShowEarthExplorer;
