...
EarthExplorerBase::EarthExplorerBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_stSpeed = new wxStaticText( this, wxID_ANY, _("000"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stSpeed->Wrap( -1 );
	...
	m_SliderSpeed = new wxSlider( this, wxID_ANY, 0, 0, 300, wxDefaultPosition, wxSize( 300,-1 ), 0 );
	...
	m_staticText8 = new wxStaticText( this, wxID_ANY, _("300"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_buttonCamera = new wxButton( this, wxID_ANY, _("Camera"), wxDefaultPosition, wxDefaultSize, 0 );
	m_buttonCamera->SetFont( wxFont( 12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxT("Arial") ) );
	m_buttonCamera->SetMinSize( wxSize( 50,-1 ) );

	fgSizer82->Add( m_buttonCamera, 1, wxALL|wxEXPAND, 2 );
	...
	// Connect Events
	this->Connect( wxEVT_CLOSE_WINDOW, wxCloseEventHandler( EarthExplorerBase::OnClose ) );
	m_buttonMid->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EarthExplorerBase::OnMidships ), NULL, this );
	m_bpPlay->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EarthExplorerBase::OnStart ), NULL, this );
	m_bpStop->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EarthExplorerBase::OnStop ), NULL, this );
	m_buttonStandby->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EarthExplorerBase::OnStandby ), NULL, this );
	m_buttonAuto->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EarthExplorerBase::OnAuto ), NULL, this );
	m_buttonCamera->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EarthExplorerBase::OnCamera ), NULL, this );
	m_buttonWind->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EarthExplorerBase::OnWind ), NULL, this );
	m_buttonMinus1->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EarthExplorerBase::OnMinus1 ), NULL, this );
	m_buttonMinus10->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EarthExplorerBase::OnMinus10 ), NULL, this );
	m_buttonPlus10->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EarthExplorerBase::OnPlus10 ), NULL, this );
	m_buttonPlus1->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EarthExplorerBase::OnPlus1 ), NULL, this );
	this->Connect( wxID_ANY, wxEVT_TIMER, wxTimerEventHandler( EarthExplorerBase::OnTimer ) );
}

EarthExplorerBase::~EarthExplorerBase()
{
	// Disconnect Events
	this->Disconnect( wxEVT_CLOSE_WINDOW, wxCloseEventHandler( EarthExplorerBase::OnClose ) );
	m_buttonMid->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EarthExplorerBase::OnMidships ), NULL, this );
	m_bpPlay->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EarthExplorerBase::OnStart ), NULL, this );
	m_bpStop->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EarthExplorerBase::OnStop ), NULL, this );
	m_buttonStandby->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EarthExplorerBase::OnStandby ), NULL, this );
	m_buttonAuto->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EarthExplorerBase::OnAuto ), NULL, this );
	m_buttonCamera->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EarthExplorerBase::OnCamera ), NULL, this );
	m_buttonWind->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EarthExplorerBase::OnWind ), NULL, this );
	m_buttonMinus1->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EarthExplorerBase::OnMinus1 ), NULL, this );
	m_buttonMinus10->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EarthExplorerBase::OnMinus10 ), NULL, this );
	m_buttonPlus10->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EarthExplorerBase::OnPlus10 ), NULL, this );
	m_buttonPlus1->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( EarthExplorerBase::OnPlus1 ), NULL, this );
	this->Disconnect( wxID_ANY, wxEVT_TIMER, wxTimerEventHandler( EarthExplorerBase::OnTimer ) );

}

EarthExplorerPreferences::EarthExplorerPreferences( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
...
EarthExplorerPreferences::~EarthExplorerPreferences()
{
}
